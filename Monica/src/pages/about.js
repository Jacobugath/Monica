...
const IndexPage = () => (
  <div className="container">
    ...
    <div className="links"><Link to = '/'>HOME</Link> <u><Link to = '/about'>ABOU</Link><span className="reg"><Link to = '/about'>T M</Link></span><Link to = '/about'>E</Link></u>{'    '} <Link to='/contact'>CONTAC</Link><span className="reg"><Link to='/contact'>T M</Link></span><Link to='/contact'>E</Link> {'   '}</div>
    </div>
      <div className="heading"><h1>ABOUT ME</h1></div>
      <div className="pic"></div>
      <div className="text">I am a professional wedding photographer based in Salt Lake City, Utah who loves to explore and shoot in the beautiful outdoors. Exploring new places and traveling inspire me! ;) I can be easily bribed with a large Diet Coke and sunshine. The beach is my happy place and you will find me in my flip-flops all year round – except if there is snow on the ground.

My husband and I met on a blind date in college and we have been best friends ever since. We have 5 children – 4 boys (including identical twins) and a girl at the end. After some nudging from my husband in 2010, I signed up for my first ever photography class and learned how to shoot in manual mode on my camera.</div>
